...
class Ui_AccountsForm(object):
    def setupUi(self, AccountsForm, loginform, user):
        ...
        AccountsForm.setFont(font)
        AccountsForm.setStyleSheet("background-color: #5e4f47")
        ...
        self.pb_addtransaction.setGeometry(QtCore.QRect(40, 470, 131, 28))
        font = QtGui.QFont()
        font.setFamily("OCR A Extended")
...
"color: #fff")
        ...
        self.pb_analyze.setGeometry(QtCore.QRect(480, 460, 201, 28))
        font = QtGui.QFont()
        font.setFamily("OCR A Extended")
...
"color: #fff")
        ...
        self.layoutWidget1 = QtWidgets.QWidget(AccountsForm)
        ...
        self.pb_createtransfer = QtWidgets.QPushButton(AccountsForm)
        self.pb_createtransfer.setGeometry(QtCore.QRect(190, 470, 131, 28))
        font = QtGui.QFont()
        font.setFamily("OCR A Extended")
