...
class Exporter(ABC):
    """Exporter class"""
    @abstractmethod
    def create(self, account_dto: AccountDTO, output: str):
        """Create method"""
    @abstractmethod
...
class PdfExport(Exporter):
    ...
    def create(self, account_dto: AccountDTO, output: str):
        ...
        self.pdf.cell(0, 10, txt="Account Name: " + account_dto.name, ln=1, align="L")
        self.pdf.cell(0, 10, txt="Account Balance: $" + str(account_dto.balance), ln=1, align="L")
        ...
        for transaction in account_dto.transactions:
...
class CsvExport(Exporter):
    ...
    def create(self, account_dto: AccountDTO, output: str):
        """Create csv method"""
        self.csv += "Account name: " + account_dto.name + "\n"
        self.csv += "Account balance: " + str(account_dto.balance) + "\n"
